...
\hline
\multirow{3}{*}{\textbf{Algoritam}}      & \multicolumn{4}{c|}{\textbf{IRIS}}                                          & \multicolumn{4}{c|}{\textbf{WINE}}                                  \\ \cline{2-9} 
                                         & \multicolumn{2}{c|}{\textbf{DB}} & \multicolumn{2}{c|}{\textbf{CZ}}         & \multicolumn{2}{c|}{\textbf{DB}} & \multicolumn{2}{c|}{\textbf{CZ}} \\ \cline{2-9} 
                                         & c         & index                & c & index                                & c         & index                & c         & index                \\ \hline
\multicolumn{1}{|c|}{\textbf{K Sredina}} & 2         & 0.40                & 3 & 561.62                               & 3         & 0.53                 & 3         & 561                  \\ \hline
\multicolumn{1}{|c|}{\textbf{PSO}}       & 2         & \textbf{0.28}        & 3 & \multicolumn{1}{l|}{\textbf{575.69}} & 3         & \textbf{0.47}        & 3         & \textbf{576}         \\ \hline
\end{tabular}
\end{table}
